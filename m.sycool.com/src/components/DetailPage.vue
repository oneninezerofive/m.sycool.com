<template>
  <div style="background:#fff">
    ...
    <!-- 内容 -->
    <div class="box">
      <div class="price">￥{{detail.currentPrice}}</div>
    ...
    <van-goods-action>
      ...
      <van-popup v-model="show" position="bottom" :style="{ height: '85%' }">
        ...
        <van-tabs v-model="active">
          <div class="jiage">￥{{detail.currentPrice}}</div>
...
export default {
  ...
  async created() {
    ...
    this.listimg = detail.data[0].imgSrc;
    this.listImgs = detail.data[0].gDetailsImgSrc;
    this.listgAttr = detail.data[0].gAttr;
  }
};
</script>
