<template>
	...
	<div>
		...
		<!-- <div class="shop_lis" v-show="bool">
			<div class="main" v-for="(v,i) in this.mycar" :key="i">
				<div class="input_box">
					<input type="checkbox" />
				</div>
				<div class="img_box">
				...
				<div class="btn_box">
					...
					<div class="btn">
						<span class="price">{{v.currentPrice}}</span>
						<van-stepper style="margin-right:20px" v-model="v.number" />
					</div>
				</div>
			</div>
		</div> -->

		<van-checkbox-group v-model="result" v-show="bool">
			<van-checkbox v-for="(v, i) in this.mycar" :key="i" :name="v">
